...
EmployeeInterface empService;
    ...
    public Map<Integer,Employees> EmployeeDetailsBasedOnInsurance(Map<Integer,Employees> hm){
    	System.out.println("Enter an InsuranceSchema :\n1. Scheme A\n2. Scheme B\n3. Scheme C\n4. NoScheme");
    	int option = Integer.parseInt(sc.nextLine());
    	Map<Integer,Employees> map = new HashMap<Integer,Employees>();
    	switch(option) {
    	case 1:map = empService.getDetailsSchemeBased(hm,"Scheme A");
    		   break;
    	case 2:map = empService.getDetailsSchemeBased(hm,"Scheme B");
    		   break;
    	case 3:map = empService.getDetailsSchemeBased(hm,"Scheme C");
    		   break;
    	case 4:map = empService.getDetailsSchemeBased(hm,"No Scheme");
    		   break;
    	}
    	return map;
